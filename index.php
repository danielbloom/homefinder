...
<body>
 ...
 <!--   <script src="http://cdnjs.cloudflare.com/ajax/libs/backbone.js/1.1.2/backbone-min.js"></script>
  <script src="http://cdnjs.cloudflare.com/ajax/libs/backbone.js/1.1.2/backbone-min.js"></script>-->
<header><h1>Find Home</h1>
location lookup, pagination, front end validation, validate code, concatinate,  apache rewrite amazon, readme, github</header>

<div id="mainContent">
<form id="filter">
    <input name="area" value="chicago, il" placeholder="Area (e.g. Chicago, IL)"> Price range
...
<div id="pagination"></div>
  ...
  <script src="js/homefinder.js"></script>
<footer>
</footer>
</body>
</html>